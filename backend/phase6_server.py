...
from phase6_hamilton_ai import HamiltonSnakeAI
...
class HamiltonHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        self._send_json({"status": "ok", "algorithm": "phase6-hamilton"})
    ...
    def do_POST(self):
        ...
        if self.path == "/init":
            ...
            try:
                ...
                self._send_json({"direction": dir_name, "algorithm": "phase6-hamilton"})
