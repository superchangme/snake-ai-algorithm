#!/usr/bin/env python3
"""
Phase 6 Hamilton Snake AI API Server
端口: 8088
"""
...
from phase7_odd_hamilton_ai import HamiltonSnakeAI
...
class HamiltonHandler(BaseHTTPRequestHandler):
    def _send_json(self, data, status=200):
        ...
        # Add Content-Length for bun compatibility
    ...
    def do_GET(self):
        self._send_json({"status": "ok", "algorithm": "phase7-hamilton"})
    ...
    def do_POST(self):
        ...
        if self.path == "/init":
            ...
            try:
                ...
                self._send_json({"direction": dir_name, "algorithm": "phase7-hamilton"})
            ...
            try:
                ...
                if game_id in game_records:
                    ...
                    game_records[game_id]["last_direction"] = game_records[game_id].get("last_direction", "RIGHT")
                    game_records[game_id]["death_position"] = {
                        "x": death_x,
                        "y": death_y,
                    }
                    ...
                    print(
                        f"[GAMEOVER] game_id={game_id}, score={score}, reason={death_reason}"
                    )
...
def main():
    print(f"🚀 Phase 6 Hamilton API - 端口 {PORT}")
